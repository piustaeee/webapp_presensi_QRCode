    ...
    <body>
        <div class="container">
            ...
            <form action="<?php echo base_url('Admin/KelolaData/insertAkunPegawai') ?>" method="POST">
                <input type="hidden" name="nip" value="<?= $nip ?>">
                <input type="hidden" name="email" value="<?= $email ?>">

                <!-- Username -->
                <label for="username">Username:</label>
                <input type="text" id="username" name="username" maxlength="50" placeholder="Masukkan username" value="<?= set_value('username'); ?>">
                ...
                <select id="status_akun" name="status_akun" required>
                    <option value="1" <?= set_select('status_akun', '1'); ?>>Aktif</option>
                    <option value="0" <?= set_select('status_akun', '0'); ?>>Tidak Aktif</option>
                </select>
                <?= form_error('status_akun', '<div class="text-danger">', '</div>'); ?>
